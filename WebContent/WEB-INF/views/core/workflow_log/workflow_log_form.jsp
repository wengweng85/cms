...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="workflowLog.management"/> - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr>
    <td class="in-lab" width="15%"><em class="required">*</em><s:message code="workflowLog.name"/>:</td>
    <td class="in-ctt" width="35%"><f:text name="name" value="${oprt=='edit' ? (bean.name) : ''}" class="required" style="width:180px;"/></td>
    <td class="in-lab" width="15%"><s:message code="workflowLog.name"/>:</td>
    <td class="in-ctt" width="35%"><f:text name="name" value="${oprt=='edit' ? (bean.name) : ''}" class="required" style="width:180px;"/></td>
  </tr>
  <tr>
    <td colspan="4" class="in-opt">
