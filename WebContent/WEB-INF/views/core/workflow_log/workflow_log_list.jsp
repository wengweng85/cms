...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="workflowLog.management"/> - <s:message code="list"/></span>
...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  <label class="c-lab"><s:message code="workflowLog.name"/>: <input type="text" name="search_CONTAIN_name" value="${search_CONTAIN_name[0]}"/></label>
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls-tb margin-top5">
  ...
  <tr class="ls_table_th">
    ...
    <th class="ls-th-sort"><span class="ls-sort" pagesort="name"><s:message code="workflowLog.name"/></span></th>
  </tr>
  </thead>
  <tbody>
