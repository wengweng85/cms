...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="publishPoint.management"/> - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr>
    ...
    <td class="in-lab" width="15%"><s:message code="publishPoint.type"/>:</td>
    <td class="in-ctt" width="35%">
      <select name="type">
  ...
  <tr>
    <td class="in-lab" width="15%"><s:message code="publishPoint.storePath"/>:</td>
    <td class="in-ctt" width="35%"><f:text name="storePath" value="${bean.storePath}" maxlength="255" style="width:180px;"/></td>
    <td class="in-lab" width="15%"><s:message code="publishPoint.displayPath"/>:</td>
    <td class="in-ctt" width="35%"><f:text name="displayPath" value="${bean.displayPath}" maxlength="255" style="width:180px;"/></td>
  </tr>
  <tr class="ftp-tr" style="display:none;">
    <td class="in-lab" width="15%"><s:message code="publishPoint.ftpHostname"/>:</td>
    <td class="in-ctt" width="35%"><f:text name="ftpHostname" value="${bean.ftpHostname}" maxlength="100" style="width:180px;"/></td>
    <td class="in-lab" width="15%"><s:message code="publishPoint.ftpPort"/>:</td>
    <td class="in-ctt" width="35%"><f:text name="ftpPort" value="${bean.ftpPort}" class="digits" maxlength="11" style="width:180px;"/></td>
  </tr>
  <tr class="ftp-tr" style="display:none;">
    <td class="in-lab" width="15%"><s:message code="publishPoint.ftpUsername"/>:</td>
    <td class="in-ctt" width="35%"><f:text name="ftpUsername" value="${bean.ftpUsername}" maxlength="100" style="width:180px;"/></td>
    <td class="in-lab" width="15%"><s:message code="publishPoint.ftpPassword"/>:</td>
    <td class="in-ctt" width="35%"><f:text name="ftpPassword" value="${bean.ftpPassword}" maxlength="100" style="width:180px;"/></td>
  </tr>
  <tr>
    <td colspan="4" class="in-opt">
