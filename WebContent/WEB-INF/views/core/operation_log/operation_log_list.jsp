...
<form action="list.do" method="get">
    ...
    <label class="c-lab"><s:message code="operationLog.name"/>: <input type="text" name="search_CONTAIN_name" value="${search_CONTAIN_name[0]}" style="width:100px;"/></label>
    <label class="c-lab"><s:message code="operationLog.user"/>: <input type="text" name="search_CONTAIN_user.username" value="${search_CONTAIN_user.username[0]}" style="width:100px;"/></label>
    ...
    <label class="c-lab"><s:message code="operationLog.dataId"/>: <input type="text" name="search_CONTAIN_dataId" value="${search_CONTAIN_dataId[0]}" style="width:50px;"/></label>
    <label class="c-lab"><s:message code="operationLog.ip"/>: <input type="text" name="search_CONTAIN_ip" value="${search_CONTAIN_ip[0]}" style="width:100px;"/></label>
