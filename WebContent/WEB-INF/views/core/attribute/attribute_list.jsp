...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls-tb margin-top5">
  ...
  <tr>
    ...
    <td align="center">
 			...
 			<label><f:checkbox name="scale" value="${bean.scale}" default="false"/><s:message code="attribute.scale"/></label>
 			<label><f:checkbox name="exact" value="${bean.exact}" default="false"/><s:message code="attribute.exact"/></label>
	    <label><f:checkbox name="watermark" value="${bean.watermark}" default="false"/><s:message code="attribute.watermark"/></label>
    </td>
  </tr>
  </c:forEach>
  </tbody>
