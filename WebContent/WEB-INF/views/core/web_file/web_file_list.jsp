...
<div class="ls-bc-opt">
  ...
  var swfupload = Cms.swfUpload("file",{
	  upload_url: "upload.do;jsessionid=<%=request.getSession().getId()%>",
	  post_params: {
      "parentId": "${parentId}"
    },
