...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="userGlobal.management"/> - <s:message code="list"/></span>
...
<form action="list.do" method="get">
    ...
    <label class="c-lab"><s:message code="user.group"/>:
      <select name="search_EQ_JuserGroups.group.id">
        ...
        <option value="${group.id}"<c:if test="${group.id eq requestScope['search_EQ_JuserGroups.group.id'][0]}"> selected="selected"</c:if>>${group.name}</option>
        </c:forEach>
      </select>
    </label>
