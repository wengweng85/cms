...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="userGlobal.management"/> - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr>
    ...
    <td class="in-ctt" width="35%"><f:text name="username" value="${oprt=='edit' ? (bean.username) : ''}" class="{required:true,remote:{url:'../user/check_username.do',type:'post',data:{original:'${oprt=='edit' ? (bean.username) : ''}'}}}" style="width:180px;"/></td>
    ...
    <td class="in-ctt" width="85%" colspan="3">
    	<div>
			...
			<div id="roles"<c:if test="${!empty bean.type && bean.type==0}"> style="display:none;"</c:if> style="padding-top:3px;">
	    		...
	    		<f:checkboxes name="roleIds" items="${site.roles}" checked="${bean.roles}" itemLabel="name" itemValue="id"/>
	    		</div>
				</c:forEach>
    	</div>
    </td>
