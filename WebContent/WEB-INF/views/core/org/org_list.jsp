...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="org.management"/> - <s:message code="list"/></span>
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls-tb margin-top5">
  ...
  <tr beanid="${bean.id}">
    ...
    <td><span style="padding-left:${bean.treeLevel*12}px"><f:text name="name" value="${bean.name}" style="width:120px;"/></span></td>
