...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="workflowGroup.management"/> - <s:message code="list"/></span>
...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  <label class="c-lab"><s:message code="workflowGroup.name"/>: <input type="text" name="search_CONTAIN_name" value="${search_CONTAIN_name[0]}"/></label>
...
<tags:search_params/>
<div class="ls-bc-opt">
	<shiro:hasPermission name="core:workflow_group:create">
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls-tb margin-top5">
  ...
  <tr class="ls_table_th">
    ...
    <th class="ls-th-sort"><span class="ls-sort" pagesort="name"><s:message code="workflowGroup.name"/></span></th>
    <th class="ls-th-sort"><span class="ls-sort" pagesort="description"><s:message code="workflowGroup.description"/></span></th>
  </tr>
  </thead>
  <tbody>
  <c:forEach var="bean" varStatus="status" items="${list}">
  <tr<shiro:hasPermission name="core:workflow_group:edit"> ondblclick="location.href=$('#edit_opt_${bean.id}').attr('href');"</shiro:hasPermission>>
