...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="320">
  		<div>
  			<f:text id="${id}" name="${name}" value="${value}" onchange="fn_${id}(this.value);" style="width:300px;"/>
  		</div>
      ...
      <div style="margin-top:2px;">
        <label><input type="checkbox" id="s_${id}"/><s:message code="scale"/></label> &nbsp;
        <label><input type="checkbox" id="e_${id}"/><s:message code="exact"/></label> &nbsp;
        <label><input type="checkbox" id="wm_${id}"/><s:message code="watermark"/></label>
      </div>
