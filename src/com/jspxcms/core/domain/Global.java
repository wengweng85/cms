...
//	@Transient
//	public static boolean isDocEnabled() {
...
//	}
	...
	public String getTemplateDisplayPathByCtx() {
		...
		if (StringUtils.isNotBlank(ctx)
				&& (StringUtils.isBlank(Constants.TEMPLATE_DISPLAY_PATH) || StringUtils
						.startsWith(Constants.TEMPLATE_DISPLAY_PATH, "/"))) {
			sb.append(ctx);
		}
	...
	public String getStaticDisplayPath() {
		...
		StringBuilder sb = new StringBuilder();
		if (StringUtils.isNotBlank(ctx)
				&& (StringUtils.isBlank(Constants.STATIC_DISPLAY_PATH) || StringUtils
						.startsWith(Constants.STATIC_DISPLAY_PATH, "/"))) {
			sb.append(ctx);
		}
