...
public class InfoController {
	...
	public String save(Info bean, InfoDetail detail, Integer[] nodeIds,
		...
		logService.operation("info.save", bean.getTitle(), null, bean.getId(),
				ip, userId, siteId);
	...
	public String update(@ModelAttribute("bean") Info bean,
		...
		String ip = Servlets.getRemoteAddr(request);
		logService.operation("info.update", bean.getTitle(), null,
	...
	public String auditPass(Integer[] ids, String opinion, Integer position,
		...
		String ip = Servlets.getRemoteAddr(request);
		for (Info bean : beans) {
			logService.operation("info.auditPass", bean.getTitle(), null,
	...
	public String auditReject(Integer[] ids, String opinion, Integer position,
		...
		String ip = Servlets.getRemoteAddr(request);
		for (Info bean : beans) {
			logService.operation("info.auditReject", bean.getTitle(), null,
					bean.getId(), ip, userId, siteId);
	...
	public String auditReturn(Integer[] ids, String opinion, Integer position,
		...
		String ip = Servlets.getRemoteAddr(request);
		for (Info bean : beans) {
			logService.operation("info.auditReturn", bean.getTitle(), null,
					bean.getId(), ip, userId, siteId);
